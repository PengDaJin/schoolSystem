        ...
        <rj-content-box title="" color="#ff9149">
            <el-row :gutter="40">
                    ...
                    <el-form-item label="教室类型" prop="roomtype">
                        <el-input v-model="dataForm.roomtype" placeholder="教室类型"></el-input>
                    </el-form-item>
                </el-col>
                                                            <el-col :inline="true" :span="8">
                    ...
                    <el-form-item label="教具信息描述" prop="realiainfo">
                        <el-input v-model="dataForm.realiainfo" placeholder="教具信息描述"></el-input>
                    </el-form-item>
                </el-col>
                                                            <el-col :inline="true" :span="8">
                    <el-form-item label="教室可预约状态 0允许预约 1无法预约" prop="status">
                        <el-input v-model="dataForm.status" placeholder="教室可预约状态 0允许预约 1无法预约"></el-input>
                    </el-form-item>
                </el-col>
                                                            <el-col :inline="true" :span="8">
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          status: [
            { required: true, message: '教室可预约状态 0允许预约 1无法预约不能为空', trigger: 'blur' }
          ],
          deleted: [
    ...
    methods: {
      ...
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/sys/roominfo/info/${this.dataForm.id}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/sys/roominfo/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
