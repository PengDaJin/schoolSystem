    ...
    <template v-if="operateType === 0">
      ...
      <rj-content>
        <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle"
          ...
          <el-table-column prop="useperiod" header-align="center" align="center" label="时段名称">
          </el-table-column>
          <el-table-column prop="starttime" header-align="center" align="center" label="使用时间">
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getDataList () {
      ...
      this.$http({
        url: this.$http.adornUrl('/timeinfo/list'),
        method: 'get',
