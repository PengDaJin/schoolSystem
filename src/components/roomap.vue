    ...
    <template v-if="operateType === 0">
      ...
      <rj-content>
        <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle"
          ...
          <el-table-column prop="actname" header-align="center" align="center" label="活动名称">
          </el-table-column>
          <el-table-column prop="lessonnum" header-align="center" align="center" label="课程编号">
          </el-table-column>
          <el-table-column prop="weeknumid" header-align="center" align="center" label="周时间id">
          </el-table-column>
          <el-table-column prop="usetimeid" header-align="center" align="center" label="使用时间id">
          </el-table-column>
          <el-table-column prop="period" header-align="center" align="center" label="周时段">
          </el-table-column>
          <el-table-column prop="ordernum" header-align="center" align="center" label="使用人证件号">
          </el-table-column>
          <el-table-column prop="orderstatus" header-align="center" align="center" label="预约教室状态 0正在预约 1预约成功 2预约失败">
          </el-table-column>
          <el-table-column prop="usestatus" header-align="center" align="center" label="使用状态 0未使用 1使用中">
          </el-table-column>
