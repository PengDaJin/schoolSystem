        ...
        <rj-content-box title="" color="#ff9149">
            <el-row :gutter="40">
                    ...
                    <el-form-item label="课程名称" prop="lessonname">
                        <el-input v-model="dataForm.lessonname" placeholder="课程名称"></el-input>
                    </el-form-item>
                </el-col>
                                                            <el-col :inline="true" :span="8">
    ...
    methods: {
      ...
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/sys/lessoninfo/info/${this.dataForm.id}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/sys/lessoninfo/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
