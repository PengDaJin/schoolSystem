    ...
    >
      ...
      >
        <el-row :gutter="40">
          ...
          <el-col :inline="true" :span="8">
            <el-form-item label="预约教室状态" prop="orderstatus">
              <!-- 0正在预约 1预约成功 2预约失败 -->
              <el-input
    ...
    return {
      ...
      dataRule: {
        ...
        orderstatus: [
          {
            required: true,
            message: "预约教室状态 0正在预约 1预约成功 2预约失败不能为空",
            trigger: "blur",
          },
        ],
        usestatus: [
        ...
        if (valid) {
          this.$http({
            url: this.$http.adornUrl(
              `/roomap/${!this.dataForm.id ? "save" : "update"}`
            ),
            method: "post",
